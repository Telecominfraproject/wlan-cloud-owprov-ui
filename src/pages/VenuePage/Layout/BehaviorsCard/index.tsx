...
const VenueBehaviorsCard = ({ id }: Props) => {
        ...
        <Box w="100%">
          {getVenue.data ? (
            <Formik
              ...
              enableReinitialize
              key={formKey}
              initialValues={getVenue.data as VenueApiResponse}
            ...
            >
              <VenueDetailsForm isDisabled={!isEditing || getVenue.isFetching || updateVenue.isLoading} />
            </Formik>
          ) : (
            <Center my={12}>
              <Spinner size="xl" />
...
export default VenueBehaviorsCard;
