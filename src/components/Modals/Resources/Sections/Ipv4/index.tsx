...
export const EDIT_SCHEMA = (t: (str: string) => string) =>
  object().shape({
    ...
    editing: INTERFACE_IPV4_SCHEMA(t),
  });
...
const InterfaceIpv4Resource = ({ isOpen, onClose, refresh, formRef, resource, isDisabled = false, parent }: Props) => {
    ...
    <Formik
      ...
      initialValues={
        resource !== undefined && resource.variables[0]
          ...
          : {
              editing: { ...INTERFACE_IPV4_SCHEMA(t, true).cast() },
              _unused_name: 'IPv4',
              _unused_description: '',
              _unused_notes: [],
            }
...
export default InterfaceIpv4Resource;
