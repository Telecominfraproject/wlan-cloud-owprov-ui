...
const EntityInfoCard = ({ refreshPage }) => {
  ...
  return (
    <CCard>
      <CCardHeader className="p-1 text-light" style={{ backgroundColor: '#2f3d54' }}>
        ...
        <div className="text-right float-right">
          <CButtonToolbar role="group" className="justify-content-end">
            <CPopover content={t('common.save')}>
              <CButton disabled={!editing} color="info" onClick={editEntity} className="mx-1">
            ...
            <CPopover content={t('common.delete')}>
              <CButton disabled={editing} color="danger" onClick={toggleDelete} className="mx-1">
                <CIcon name="cil-trash" content={cilTrash} />
              </CButton>
            </CPopover>
            <CPopover content={t('common.refresh')}>
              <CButton disabled={editing} color="info" onClick={refreshPage} className="mx-1">
